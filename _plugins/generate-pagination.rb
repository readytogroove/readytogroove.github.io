...
#         paginate_categories(site, '/blog/categories', 'blog.html', site.categories['blog'])
#         paginate_categories(site, '/questions/categories', 'the-cycle.html', site.categories['the-cycle'])
#       end
...
#         categories = []
#         restricted_categories = ['blog', 'the-cycle']
