...
category: the-cycle
excerpt: "Learn how to practice the sympto-thermal method of fertility awareness to naturally prevent pregnancy, to maximize your chances of getting pregnant quickly, or to learn about your body. Properly learning this information can help you prevent pregnancy with an effectiveness that rivals hormonal contraceptives."
---

We have finally gotten to the good stuff. Before we get started, I must mention that it is _imperative_ that you have a thorough understanding of the <a class="text-link" href="/the-cycle/chapter-4-female-reproductive-organs-and-endocrine-glands">female reproductive system and endocrine glands</a>, how <a class="text-link" href="/the-cycle/chapter-5-female-hormones-and-the-menstrual-cycle">female sex hormones</a> affect the menstrual cycle, and how these hormone fluctuations <a class="text-link" href="/the-cycle/chapter-6-hormone-changes-and-fertility-signals">manifest as fertility signs</a> before attempting to learn _or_ practice the sympto-thermal method (STM). Although there are other methods that fall into the category of "fertility awareness," or FA, (including the Billings Method, which monitors only cervical fluid changes), the sympto-thermal method of FA is the only method that I refer to in this book. Not only is it the most effective method of FA, but it can be used by most women regardless of cycle length, cycle irregularity, or reproductive disorders. When the rules presented here are strictly adhered to, the sympto-thermal method of FA is an extremely effective way to prevent or achieve pregnancy&mdash;or to simply keep track of gynecological health. Just how effective is it? It&rsquo; <a class="text-link" href="/the-cycle/chapter-9-sympto-thermal-method-effectiveness">highly effective</a>! But I&rsquo;ll explain that more later. I also discuss how to use STM to <a class="text-link" href="/the-cycle/appendix-a-the-sympto-thermal-method-for-pregnancy-prevention">prevent pregnancy without hormones</a>, to maximize your chances of <a class="text-link" href="/the-cycle/appendix-b-the-sympto-thermal-method-for-pregnancy-assistance">getting pregnant</a>, or to <a class="text-link" href="/the-cycle/appendix-c-the-sympto-thermal-method-for-reproductive-health">improve your reproductive health</a> a little later on. An understanding of the STM rules presented in this section is necessary to grasp the information I just mentioned, so make sure to learn about <a class="text-link" href="/the-cycle/chapter-8-checking-fertility-signs-how-to">how to check fertility signs</a> and <a class="text-link" href="/the-cycle/chapter-9-sympto-thermal-method-effectiveness">how effective STM can be</a> before diving into any of that extra information. 

It is absolutely _crucial_ (and I cannot stress this enough) that you read this section very carefully before attempting to practice STM. If you don't quite get it after the first read, then read it again! Just make sure you have a good understanding of the material before attempting to use this method for any purpose, but especially as a form of pregnancy prevention. I also highly recommend that if you do not feel confident in your knowledge of STM (or if you or your partner are confused by any fertility signs), get in touch with a fertility awareness educator to help out with the transition. There are tons of <a class="text-link" href="/the-cycle/appendix-d-fertility-awareness-and-menstrual-health-resources">educators and other amazing resources</a> available out there. 
...
The last day of slippery, fertile quality cervical fluid is considered the peak day. Because the peak day is the _last day_ of slippery fluid, a woman won't be able to identify her peak day until the following day. Some women may never experience slippery, fertile quality fluid. For these women, the peak day is the last day of the most fertile type of fluid observed, even if it is not slippery, watery, or egg white. The peak day may occur a few days before ovulation, and is generally the most fertile day of the menstrual cycle. __On the evening of the fourth day after her peak day, a woman is considered infertile for the remainder of her cycle.__ This rule *must* be double-checked with the "Temperature Shift Rule" below, as stated in the "Double-Check Rule" I will discuss shortly. We'll discuss how to identify peak day when I discuss <a class="text-link" href="/the-cycle/chapter-8-checking-fertility-signs-how-to">how to check fertility signs</a>.
...
After ovulation, as sort of a "confirmation" that the infertile period has begun, many women will <a class="text-link" href="/the-cycle/chapter-8-checking-fertility-signs-how-to">check the position of the cervix</a> to confirm that it has returned to its infertile (low, firm, and closed) position. It is a great way to provide a little extra peace of mind! I will discuss this more soon.
...
<div class="arrows">
	<h3><a class="text-link previous" href="/the-cycle/chapter-6-hormone-changes-and-fertility-signals/" title="Previous Excerpt">&laquo; Previous</a><a class="text-link next" href="/the-cycle/chapter-8-checking-fertility-signs-how-to/" title="Next Excerpt">Next &raquo;</a></h3>
</div>
